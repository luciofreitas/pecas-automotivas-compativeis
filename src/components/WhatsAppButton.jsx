    ...
    <div className="whatsapp-button-container">
      <div className="whatsapp-button-wrapper">
        <a
          ...
          ariaLabel={`Contato via WhatsApp: ${vehicle || ''}`}
        >
          <svg viewBox="0 0 24 24" fill="currentColor" ariaHidden>
            <path d="M20.52 3.48-a11.9 11.9 0 0012 .5-c6.21.5 1.5 5.21 1.5 11c0 1.9.5 3.73 1.44 5.33-l.5 23.5l7.37-2.34-a11.9 11.9 0 0012 22.5c5.79 0 10.5-4.71 10.5-10.5 0-2.82-1.1-5.42-3-7.02z-m12 20.5c-1.6 0-3.17-.38-4.57-1.11l-.33-.17-4.38 1.39 1.36-3.05-.21-.34-a8.5 8.5 0 013.5 11c0-4.69 3.81-8.5 8.5-8.5 2.27 0 4.4.88 6 2.48a8.42 8.42 0 012.48 6c0 4.69-3.81 8.5-8.5 8.5z" />
